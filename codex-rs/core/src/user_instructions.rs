...
/// Wraps user instructions in a format that clearly identifies the directory and content.
...
mod tests {
    ...
    #[test]
    fn developer_instructions_into_response_item() {
        let response: ResponseItem = DeveloperInstructions::new("test_text").into();
        assert_eq!(
            response,
            ResponseItem::Message {
                id: None,
