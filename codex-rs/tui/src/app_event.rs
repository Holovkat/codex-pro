...
pub(crate) enum AppEvent {
    ...
    /// Open the Windows world-writable directories warning confirmation.
    ...
    /// Update whether the world-writable directories warning prompt has been acknowledged.
    #[cfg_attr(not(target_os = "windows"), allow(dead_code))]
    ...
    /// Persist the acknowledgement flag for the world-writable directories warning prompt.
    #[cfg_attr(not(target_os = "windows"), allow(dead_code))]
    PersistWorldWritableWarningAcknowledged,

    /// Skip the next world-writable scan once after confirmation.
    #[cfg_attr(not(target_os = "windows"), allow(dead_code))]
